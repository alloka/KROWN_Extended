...
# Souffle
echo "*** Building Souffle $SOUFFLE_VERSION ... ***"
cd Souffle
docker build --build-arg SOUFFLE_VERSION=$SOUFFLE_VERSION \
    -t alloka/souffle:v$SOUFFLE_VERSION .
